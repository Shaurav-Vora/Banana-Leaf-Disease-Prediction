      ...
      <div className="p-8 bg-white shadow-lg rounded-lg w-full max-w-xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center">
          <div className="w-full flex justify-center mb-4">
            <label
              htmlFor="fileInput"
              className="mt-6 px-4 py-2 bg-blue-500 text-white text-xl font-semibold rounded-lg shadow cursor-pointer hover:bg-blue-600 transition duration-200"
            >
          ...
          {preview && (
            <div className="mb-4 flex flex-col">
              ...
              <button
                ...
                className="mt-2 mb-8 px-4 py-2 bg-red-500 text-white font-semibold rounded-lg shadow hover:bg-red-600 focus:ring-2 focus:ring-red-400 focus:ring-opacity-50 transition duration-200"
              >
                Remove Image
              </button>
            </div>
